...
public class deThiDAO {
    ...
    public ArrayList<deThiDTO> layDanhSachDeThi() {
        ...
        try {
            ...
            System.out.println("Lay danh sach de thi khong thanh cong" + e.getMessage());
        }
        return arr;
    }

    public ArrayList<deThiDTO> layDeThiDSBangMaTK(String maTK, int trangThai) {
        ArrayList<deThiDTO> arr = new ArrayList<>();
        try {
            conn.Connect();
    ...
    public int laySoLuongDeThiTheoMon(String maMon) {
        try {
            ...
            System.out.println("Lay so luong de thi khong thanh cong" + e.getMessage());
        }
        return 0;
    }
    ...
    public boolean themDeThi(String maDT, String maTK, String tenDT, String matKhau, java.util.Date ngayThi, Time thoiGianBatDau, int trangThai, int soLuongCau, int thoiGianLamBai, String maLop, ArrayList<String> dsMaCH) {
        try {
            ...
            System.out.println("Them de thi khong thanh cong" + e.getMessage());
            return false;
    ...
    public void updateTrangThaiDeThi(String maDT) {
        ...
        try {
            ...
            System.out.println("Cap nhat trang thai de thi khong thanh cong" + e.getMessage());
        }
    }
