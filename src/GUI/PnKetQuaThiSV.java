...
public class PnKetQuaThiSV extends JPanel implements ActionListener{
...
//--------------------------- Sắp thi--------------------------------------
        ...
        for (int i = 0; i < tableSapThi.getColumnCount(); i++) {
            tableSapThi.getColumnModel().getColumn(i).setCellRenderer(new DisabledTableCellRenderer());
        }
