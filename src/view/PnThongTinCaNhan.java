...
public class PnThongTinCaNhan extends JPanel {
    ...
    public void initComponents() {
        ...
        btnLDay = new JButton("Xem");
//        btnLDay.setIcon(ImageUtils.createResizedIcon(GiaoDienUser.class, "..//image//eye.png", 20, 20));
        ...
        btnLHoc = new JButton("Xem");
//        btnLHoc.setIcon(ImageUtils.createResizedIcon(GiaoDienUser.class, "..//image//eye.png", 20, 20));
        ...
        btnMon = new JButton("Xem");
//        btnMon.setIcon(ImageUtils.createResizedIcon(GiaoDienUser.class, "..//image//eye.png", 20, 20));
        ...
        btnDThi = new JButton("Xem");
//        btnDThi.setIcon(ImageUtils.createResizedIcon(GiaoDienUser.class, "..//image//eye.png", 20, 20));
